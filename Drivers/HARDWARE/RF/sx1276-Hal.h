...
/*!
 * DIO state read functions mappingPBout->b4
 */
#define DIO0                                        PAin->b12
#define DIO1                                        PAin->b15
#define DIO2                                        PBin->b3
#define DIO3                                        PBin->b4
#define DIO4                                        PBin->b5
#define DIO5                                        0
#define RF_CS                                       PBout->b8
#define PA_TX                                       PCout->b14
#define PA_RX                                       PCout->b15
#define RF_RES                                      PAout->b11


//#define 	MISO	PAin->b6
//#define 	M0SI	PAout->b7
//#define 	SCK		PAout->b5


#define 	MISO	HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_6)
#define 	M0SI0	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_RESET)
#define 	M0SI1	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_7, GPIO_PIN_SET)
#define 	SCK0	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET)
#define 	SCK1	HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_SET)
